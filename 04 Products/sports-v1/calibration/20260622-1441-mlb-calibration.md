...
|---|---|---|---|---|---|---|---|---|
| New York Yankees at Detroit Tigers | 2026-06-22 | deb5433e-f36b-1410-8167-00373db4b724 | completed | monitor | 0.8 | 2 | none | 0 |
...
|---|---|---|---|---|---|
| New York Yankees at Detroit Tigers | monitor | 2 | none | confidence_high_for_partial_evidence | confidence calibration |

### Cognitive Protocol Quality

| matchup | detect | frame | aim | question | probe | verify | weigh | contrast | stress | resolve | position | justify |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| New York Yankees at Detroit Tigers | good | good | good | good | good | good | good | good | good | good | good | good |
...
Confidence Calibration Rules v1 -- confidence was high relative to evidence richness on 1 of 1 run(s).

Basis:
- confidence_high_for_partial_evidence appeared on 1 of 1 run(s)
