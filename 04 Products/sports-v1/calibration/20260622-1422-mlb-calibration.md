...
|---|---|---|---|---|---|---|---|---|
| New York Yankees at Detroit Tigers | 2026-06-22 | dbb5433e-f36b-1410-8167-00373db4b724 | completed | monitor | 0.8 | 2 | none | 0 |
...
This batch produced 1 completed artifact(s) out of 1 assessed. Evidence richness was 2 on all runs. Posture: 1x monitor. Main flags: confidence high for partial evidence on 1 run(s); protocol had possibly unsupported claims on 1 run(s).

### Per-Run Assessment

| matchup | posture | evidence | missing signals | flags | review focus |
|---|---|---|---|---|---|
| New York Yankees at Detroit Tigers | monitor | 2 | none | protocol_unsupported_claim, confidence_high_for_partial_evidence | protocol quality, confidence calibration |

### Cognitive Protocol Quality

| matchup | detect | frame | aim | question | probe | verify | weigh | contrast | stress | resolve | position | justify |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| New York Yankees at Detroit Tigers | good | good | good | good | good | generic | good | good | good | good | good | good |

## Pattern Summary

| flag | count | of |
|---|---|---|
| protocol_unsupported_claim | 1 | 1 |
