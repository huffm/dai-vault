...
**Signal Cost and Feasibility Model v1 (2026-05-11) doctrine:**
New architecture doc at `02 Platform/architecture/cognitive-factory/signal-cost-and-feasibility-model-v1.md`. Defines six signal cost tiers (Tier 0 deterministic / Tier 1 free-public / Tier 2 low-cost API / Tier 3 paid provider / Tier 4 enterprise / Tier 5 manual or sponsor-funded), the per-signal feasibility-record fields, six provider-evaluation gates, six subscription-decision conditions, four budget gates (pre-revenue $0–$30/mo, early validation $30–$100/mo, post-revenue ≤10–15% of MRR, enterprise gated by funded pilot), and seven low-cost acquisition patterns. No runtime code changed. Production sports v1 keeps ActionNetwork as the free `sharp_public` path; SportsDataIO subscription is gated on Phase A unscrambled-key verification; VSiN scraping is gated on legal review; line movement remains adjacent_proxy and is deferred; injury signal feasibility is tracked separately because injury context may have higher decision-quality ROI than sharp/public for NBA. Missing high-cost signals stay honestly visible in the artifact.
