...
## role
turn the scored signal table into a decision-ready brief narrative for a single NFL or NBA game. the synthesizer reads the signal scores and writes the human-facing content of the brief. it does not re-score or re-fetch — it interprets what the evaluator produced.
