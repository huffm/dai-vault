...
- **Proposed future slice:** No Runtime Adoption Yet / Product Deliberation v1. Backup only after explicit approval: Synthesize Runtime Inspection v1, read-only and disabled by default.
